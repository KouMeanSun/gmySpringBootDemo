...
public class TwoInterceptor implements HandlerInterceptor  {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
        ...
        if (true) {
            returnErrorResponse(response, GmyJSONResult.errorMsg("被two拦截..."));
        }
    ...
    public void returnErrorResponse(HttpServletResponse response, GmyJSONResult result) throws IOException, UnsupportedEncodingException {
